    ...
    def load_data(self, start_date, end_date):
        ...
        for race in tqdm(races, desc="Loading data"):
            ...
            for i, p in enumerate(experienced_ps):
                ...
                this_y[i, 0] = calculate_normalized_speed(p)
...
def main():
    ...
    os.mkdir("data4")
    np.savez("data4/data_x.npz", **data_x)
    np.savez("data4/data_y.npz", **data_y)
    np.savez("data4/horse_nums.npz", **horse_nums)
    np.savez("data4/top_3.npz", **top_3)

    np.savez("data4/test_data_x.npz", **test_data_x)
    np.savez("data4/test_horse_nums.npz", **test_horse_nums)
    np.savez("data4/test_top_3.npz", **test_top_3)

    np.savez("data4/final_data_x.npz", **final_data_x)
    np.savez("data4/final_horse_nums.npz", **final_horse_nums)
    np.savez("data4/final_top_3.npz", **final_top_3)
